...
public:
    ...
    Aspirant(string surname, string name, string middlname, string adress, string phonenumber, string thesis_topic) : Student(surname, name, middlname, adress, phonenumber) {
        SetTheme(theme);
    }
    ...
    //d.PrintDate();
{
 ...
 Aspirant a("Benoeva", "Malika", "Khasanovna", "Filatovo 38", "0734054476", "Compucter Science");
